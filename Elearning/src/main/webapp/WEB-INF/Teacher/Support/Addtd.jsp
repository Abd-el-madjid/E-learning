			...
			<div class="content">
				...
				<input name="type" value="td" hidden>
				  ...
				  <div class="input-box">
					  ...
					  <input  name="td" placeholder=" ..."  >
			         <span class="note">write   td Name here</span> 
			     </div>
	
				<div class="input-box">
					<span class="details">td link</span>
					 <input  name="lien_td"   placeholder=" ..." >
					...
					<span class="note">write  new link here</span>
				 	...
				 	<div class="input-box">
					<span class="details">td file</span>
					 <input type="file"  name="pdf" size="50"   placeholder=" ..." >
			       
					
					<span class="note">insert   file here</span>
				  </div>
