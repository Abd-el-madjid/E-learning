...
<section id="sid_profile" class="sid_profile">
   ...
   <div class="profile2">
      <img src="resourceex/profile_teacher.jpg" id="image" alt="">
   ...
   <ul>
	...
	<div id="info_container" class="info_container">
		...
		<div id="info_box" class="info_box"> 
			<h4>Email</h4>
           <span  class="icons"><i class="fas fa-envelope"></i></span> <p id="Email" > <c:out value="${teacher.email}"/>  </p>
        </div>
		<div id="info_box" class="info_box">
			<h4>last name</h4>
           <span  class="icons"><i class="fa-solid fa-user"></i></span> <p id="	last_name" > <c:out value="${teacher.lastname}"/>  </p>
        </div>
		<div id="info_box" class="info_box">
			<h4>First name</h4>
           <span  class="icons"><i class="fa-solid fa-user"></i></span> <p id="	" ><c:out value="${teacher.firstname}"/> </p>
        </div>
        <div id="info_box" class="info_box">
			<h4>sex</h4>
           <span class="icons"><i class='fa fa-male'></i></span> <p id="	" >  <c:out value="${teacher.sex}"/>  </p>
        </div>
		
		<div id="info_box" class="info_box">
			<h4>password</h4>
          <span  class="icons"><i class="fa-solid fa-lock"></i></span>  <p id="	" type ="password"> *********   </p>
        </div>
	 <div id="info_box" class="info_box">
			<h4>role</h4>
           <span class="icons"><i class='far fa-id-badge'></i></span> <p id="	" >  <c:out value="${teacher.type}"/></p>
        </div>
		<div id="info_box" class="info_box">
		</div>
		<div id="info_box" class="info_box">
