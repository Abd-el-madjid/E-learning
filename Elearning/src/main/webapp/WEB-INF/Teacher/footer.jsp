		...
		<footer >
			...
			<div class="box-container">
						...
						<div class="box">
							...
							<a href="accueilCentral.jsp#about">about</a>       
							<a href="accueilCentral.jsp#course">course</a>       
							<a href="accueilCentral.jsp#Ressources_étudiantes">Ressources étudiantes</a>       
							<a href="accueilCentral.jsp#news">news</a>       
            ...
            Algerie La Nouvelle Ville Ali Mendjeli, 25016 </a></p>
							<p> <a href=""><i class="fas fa-envelope"></i> webmaster@univ-constantine2</a></p>
							<p> <a href=""><i class="fas fa-phone"></i>+213 031 77 50 27 </a></p>
						</div>
