	...
	<header>
		...
		<div id="mySidenav" class="sidenav">
			...
			<ul>
				...
				<li style="display: none"><a href=""><span class="icon "><i class=" fa fa-user-plus" aria-hidden="true"></i></span>Add User</a></li>
		...
		<nav class="navbar">
			<ul>
				...
				<li><a href="./ModuleListServlet">List of Modules</a></li>
				<li  style="display: none"><a href="">Add User</a></li>
				<li style="display: none"><a href="#Ressources_étudiantes">Update User</a></li>
		...
		<div id="login" class="fas fa-user-circle"></div>
			<div id="profile" class="profile ">
				<img src="resourceex/profile_etudiant.jpg" class="image" alt="">
				<h3 class="name"> <jsp:useBean id="etudiant" scope="session" type="model.User"/>
                        <c:out value="${etudiant.lastname}"/>  <c:out value="${etudiant.firstname}"/></h3>
				<h4 id="role" class="role">
                        <c:out value="${etudiant.type}"/></h4>
