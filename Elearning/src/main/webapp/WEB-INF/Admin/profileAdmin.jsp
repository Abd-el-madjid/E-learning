...
<section id="sid_profile" class="sid_profile">
   ...
   <div class="profile2">
      <img src="resourceex/profile_admin.jpg" id="image" alt="img">
   ...
   <ul>
     <li><a class="" href="./LoginServlet"><span class="icon "><i class="fas  fa-home"></i></span>Home</a></li>
				...
				<li style="display: none"><a href="./UserListServlet"><span class="icon "><i class=" fa fa-users" aria-hidden="true"></i></span>List of Users</a></li>
	...
	<div id="info_container" class="info_container">
		...
		<div id="info_box" class="info_box"> 
			<h4>Email</h4>
           <span  class="icons"><i class="fas fa-envelope"></i></span> <p id="Email" > <c:out value="${admin.email}"/>  </p>
        </div>
		<div id="info_box" class="info_box">
			<h4>last name</h4>
           <span  class="icons"><i class="fa-solid fa-user"></i></span> <p id="	last_name" > <c:out value="${admin.lastname}"/>  </p>
        </div>
		<div id="info_box" class="info_box">
			<h4>First name</h4>
           <span  class="icons"><i class="fa-solid fa-user"></i></span> <p id="	" ><c:out value="${admin.firstname}"/> </p>
        </div>
        <div id="info_box" class="info_box">
			<h4>sex</h4>
           <span class="icons"><i class='fa fa-male'></i></span> <p id="	" >  <c:out value="${admin.sex}"/>  </p>
        </div>
        ...
        <div id="info_box" class="info_box">
			<h4>role</h4>
           <span class="icons"><i class='far fa-id-badge'></i></span> <p id="	" >  <c:out value="${admin.type}"/></p>
        </div>
		   <div id="info_box" class="info_box">
			 </div>
           <div id="info_box" class="info_box">
