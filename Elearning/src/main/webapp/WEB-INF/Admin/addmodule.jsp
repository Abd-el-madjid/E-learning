...
<%@include file="headerAdmin.jsp"%>
   <section class="home" id="home" style="
    ...
    background-size: cover;">
		...
		<div class="container">
			<div class="title">Add Module </div> 
			<div class="content">
			  <form name="addUser" action="addModule_spec"  method="post">
				<div class="user-details">
				  ...
				  <div class="input-box">
					...
					<input type="text" name="module" maxlength="100" placeholder="Enter your Email" required>
			<span class="note">write  module here</span>
					...
					<span class="details">specialite</span>
					 <select name="specialite" id="add-subject" required>
                         <option value=" ">
                                   --     specialite --
                                    </option>
